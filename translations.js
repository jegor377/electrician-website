...
(function () {
  const translations = {
    pl: {
      ...
      cap1: 'Rozdzielnica pod ładowarkę EV',
      cap2: 'Modernizacja kuchni',
      cap3: 'Oświetlenie LED w garażu',
      cap4: 'Montaż gniazdek',
      cap5: 'Montaż lampy',
      cap6: 'Montaż szynoprzewodu',
      cap7: 'Montaż gniazda w marmurze',
      cap8: 'Montaż podświetlanego lustra w łazience',
      cap9: 'Montaż żyrandola',
      cap10: 'Montaż lampy',
      ...
      footer_copy:   '© 2026 Instalacje Winiarczyk. Wszystkie prawa zastrzeżone.',
    },
    en: {
      nav_about:    'About',
      nav_work:     'Work',
      ...
      cap1: 'EV charger distribution board',
      cap2: 'Kitchen renovation',
      cap3: 'LED lighting installation in the garage',
      cap4: 'Electrical outlet installation',
      cap5: 'Light fixture installation',
      cap6: 'Busbar trunking installation',
      cap7: 'Electrical outlet installation in marble',
      cap8: 'Backlit bathroom mirror installation',
      cap9: 'Chandelier installation',
      cap10: 'Light fixture installation',
